...
3. Configure the token:
   ...
   - **Repository access:** Only select repositories → `github-claudeCode-self-healing-tests`
   - **Permissions:**
...
1. Go to repository Settings: https://github.com/vinayaksoraganvi-bot/github-claudeCode-self-healing-tests/settings/secrets/actions
